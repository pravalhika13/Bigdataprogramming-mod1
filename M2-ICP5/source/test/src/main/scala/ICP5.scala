...
object ICP5 {
  def main(args: Array[String]) {
    ...
    stationGraph.vertices.write.csv("C:\\Users\\Kite\\IdeaProjects\\test\\Graphs1\\Vertices")

    stationGraph.edges.write.csv("C:\\Users\\Kite\\IdeaProjects\\test\\Graphs1\\Edges")
